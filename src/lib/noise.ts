...
// Adapted from Ashima Arts webgl-noise library
// https://github.com/ashima/webgl-noise

/**
 * 2D Simplex noise helper functions
 */
export const NOISE_2D_HELPER = `
// Simplex 2D noise
 ...
 */
export const HSV_TO_RGB_HELPER = `
...
/**
 * Check if a string is valid GLSL (basic check)
 */
export function isValidGLSL(code: string): boolean {
  ...
  // Should have return type keywords
  const hasReturnType = /\b(void|float|vec2|vec3|vec4|mat2|mat3|mat4)\b/.test(code);
